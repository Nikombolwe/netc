...
def add_user_view(request):
        ...
        if user_form.is_valid():
            ...
            if user_type == 'officer':
                if officer_form.is_valid():
                    ...
                    # Kama ikina error, futa user aliyetengenezwa ili isiwe na unassigned user
                    user.delete()
                    messages.error(request, f"Kuna makosa kwenye fomu ya Officer: {officer_form.errors}")
                ...
                if emp_form.is_valid():
                    ...
                    # Kama ikina error, futa user aliyetengenezwa
                    user.delete()
                    messages.error(request, f"Kuna makosa kwenye fomu ya Mfanyakazi: {emp_form.errors}")
        else:
    ...
    # Tunapita data zote za DB kwenye context ili kuhakikisha Dropdowns zinasoma 100%
    context = {
        'user_form': user_form,
        'emp_form': emp_form,
